 ...
 *
 */
public class MySqlASTParamVisitor extends MySqlASTVisitorAdapter {

	private Map<String, Object> params;

	public MySqlASTParamVisitor(Map<String, Object> params) {
		super();
	...
	/* (non-Javadoc)
	 * @see com.alibaba.druid.sql.visitor.SQLASTVisitorAdapter#endVisit(com.alibaba.druid.sql.ast.expr.SQLMethodInvokeExpr)
	 */
	@Override
